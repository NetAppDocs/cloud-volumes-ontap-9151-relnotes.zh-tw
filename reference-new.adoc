...
9.15.1 P14 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。NetApp Console將提示您將現有系統升級至此修補程式版本。
...
9.15.1 P13 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。NetApp Console將提示您將現有系統升級至此修補程式版本。
