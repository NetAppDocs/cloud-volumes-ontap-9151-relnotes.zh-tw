...
最新版本的NetApp Console也引進了其他功能和增強功能。欲了解更多信息，請參閱 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html["Cloud Volumes ONTAP"^] 在控制台中管理。



== 9.15.1 P16（2025年12月22日）

9.15.1 P16 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。控制台將提示您將現有系統升級到此補丁版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P16["查看 P16 補丁修復的錯誤列表"^]（需要登入NetApp支援站點）。



== 9.15.1 P15（2025年10月24日）

9.15.1 P15 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。控制台將提示您將現有系統升級到此補丁版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P15["查看 P15 補丁修復的錯誤列表"^]（需要登入NetApp支援站點）。



== 9.15.1 P14（2025年10月9日）

9.15.1 P14 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。控制台將提示您將現有系統升級到此補丁版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P14["查看 P14 補丁修復的錯誤列表"^] （需要登入NetApp支援站點）。



== 9.15.1 P13（2025年10月9日）

9.15.1 P13 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。控制台將提示您將現有系統升級到此補丁版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P13["查看 P13 補丁修復的錯誤列表"^] （需要登入NetApp支援站點）。



== 9.15.1 P12（2025 年 8 月 22 日）

9.15.1 P12 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。BlueXP提示您將現有系統升級至此修補程式版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.15.1P12["查看 P12 補丁修復的錯誤列表"^] （需要登入NetApp支援站點）。



== 9.15.1 P11（2025 年 7 月 04 日）
